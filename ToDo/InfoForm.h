...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Location = System::Drawing::Point(55, 93);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(612, 358);
			...
			this->label2->Location = System::Drawing::Point(55, 46);
			this->label2->Name = L"label2";
			this->label2->Size = System::Drawing::Size(119, 20);
			this->label2->TabIndex = 1;
			this->label2->Text = L"О программе";
			// 
			// InfoForm
			// 
			...
			this->ClientSize = System::Drawing::Size(725, 500);
